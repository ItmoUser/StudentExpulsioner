...
public class Main {
    public static void main(String[] args) {
     ...
     ExpulsionConfig config = new ExpulsionConfig.Builder()
             .setRobotics(Boolean.valueOf(args[0]))
             .setICE(Boolean.valueOf(args[1]))
             .setSE(Boolean.valueOf(args[2]))
             .setRandom(Boolean.valueOf(args[3]))
             .setFullMoon(Boolean.valueOf(args[4]))
             .build();
